	...
	<div class="mainRootDiv cf">
		...
		<div class="mainBodyDiv">
			...
			<div class="toolsMenu cf">
				<div id="btnSaveGeometries" class="btnMain btnToolSaveDisabled"></div><div id="btnLocateDevice" class="btnMain btnToolBullsEye"></div><div id="btnNewGeoFence" class="btnMain btnToolNewGeoFence"></div>
